...
Repository/application work for UniProof began on 2026-08-16 during the active hackathon period.

## Judging Criteria

| Criterion | What the submission should demonstrate |
| --- | --- |
| Originality | Evidence-first AI research rather than one opaque generated answer |
| Design | Clear Research -> Compare -> Guide workflow with inspectable uncertainty/evidence |
| Potential Impact | Safer university decision support for international applicants |
| Technological Implementation | Structured AI + deterministic evidence gates, bounded retrieval/providers, privacy/security hardening, testing, deployment controls |
